...
/* harmony import */ var _components_header_Header__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(4264);
/* harmony import */ var _components_category_Layout__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(3008);
/* harmony import */ var _controllers_category__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1291);
/* harmony import */ var _components_footer_Footer__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(4715);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_category_Layout__WEBPACK_IMPORTED_MODULE_12__]);
_components_category_Layout__WEBPACK_IMPORTED_MODULE_12__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const Category = (props)=>{
    ...
    let urlData = [];
    let { products , taxanomy , settingsData , categoryMode , landingCategories  } = props.data;
    categoryMode = "category";
    let temProducts = [];
    let entryTime = "Y";
    // START EXTRACT SETTINGS DATA
    (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .LoadSettings */ .Pj)(settingsData, setSortBrandStatus, setSortNewestStatus, setCheckAvailability, setSortDefault, react__WEBPACK_IMPORTED_MODULE_1__.useEffect);
    // END EXTRACT SETTINGS DATA
    urlTaxonomy = (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .GetUrlTaxonomy */ .Np)(taxanomy, slug);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        try {
            setTimeout(()=>{
    ...
    (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .setInitAvailable */ .EM)(checkAvailability, setCheckAvailability);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        try {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .GetUrlData */ .f6)(urlTaxonomy, taxanomy).then((data)=>{
            setUData(data);
        });
    }, [
        taxanomy,
    ...
    fproducts = (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .liveProdsRGXSearch */ .Ss)(searchText, products);
    /*****END SEARCH PRODUCTS USING REGEX*******************/ temProducts = (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .GetProducts */ .xo)(allFilters, fproducts, property, slug, taxonomyName, taxonomyValue, dataBy);
    /*****************************END GETTING PRODUCTS ACCORING TO FILTERS***************************/ //START STATES HOOK IS HANDLING DATA ACCORING TO AVAIALBILITY FILTERS
    temProducts = (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .avaialbilityFilter */ .t9)(temProducts, checkAvailability);
    ...
    currentproducts = (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .SortProducts */ .IU)(property, currentproducts);
    currentproducts = (0,_controllers_category__WEBPACK_IMPORTED_MODULE_13__/* .PaginationCalc */ ._1)(currentproducts, productsPerPage, activePage, setCurrentPage).currentproducts;
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_category_Layout__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z, {
                products: products,
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,2623,5675,4524,4264,4715,2816,3008], () => (__webpack_exec__(9807)));
